...
set _PYTHONFILE0=J:\JA2 1.13 SVN\JA2-Character-Animation-Photobooth\batchrender-rifles0.py
set _PYTHONFILE1=J:\JA2 1.13 SVN\JA2-Character-Animation-Photobooth\batchrender-rifles1.py
