...
if %decision%==0 (
	...
	for /l %%n in (0,1,4) do (
		...
		start /B make_script\convert.exe "output\Standing - Empty Hands - Climb\!outputPrefix[%%n]!_C2*.png" "output\Standing - Empty Hands - Climb\!outputPrefix[%%n]!_C4*.png" "output\Standing - Empty Hands - Climb\!outputPrefix[%%n]!_C6*.png" "output\Standing - Empty Hands - Climb\!outputPrefix[%%n]!_C8*.png" -crop !_CROPSETTINGS! BMP3:"!_EXTRACTDIR!\0.bmp"
	)
	:SYNCLOOP1
