...
set _PYTHONFILE0=J:\JA2 1.13 SVN\JA2-Character-Animation-Photobooth\batchrender-pistols0.py
set _PYTHONFILE1=J:\JA2 1.13 SVN\JA2-Character-Animation-Photobooth\batchrender-pistols1.py
