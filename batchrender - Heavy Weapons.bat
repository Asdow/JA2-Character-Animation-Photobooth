...
set _PYTHONFILE=J:\JA2 1.13 SVN\JA2-Character-Animation-Photobooth\renderGeneratedScripts\batchrender-HeavyWeaponAnims
...
echo Rendering heavy weapons animations
