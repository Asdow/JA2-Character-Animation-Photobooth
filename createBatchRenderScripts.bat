...
JA2-BatchRenderCreator.exe "5" "Animations - Reg male - All.txt" "batchrender-unified.py"
...
JA2-BatchRenderCreator.exe "5" "Animations - Big male - All.txt" "batchrender-unified.py"
...
JA2-BatchRenderCreator.exe "5" "Animations - Female - All.txt" "batchrender-unified.py"
